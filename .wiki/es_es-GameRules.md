# ⚖️ Referencia completa de GameRules con espacio de nombres
...
## 📊 Tabla de referencia de GameRules estáticas
...
## 🌾 GameRules dinámicas de multiplicador por cultivo
...
## 🛠️ Ejemplos de comandos de administración
...
*See also: [[Comandos Brigadier y administración|es_es-Commands]], [[Configuración de dos niveles|es_es-Configuration]], and [[Registro de cultivos y soporte universal|es_es-Plant-Registry-and-Crop-Types]]*.
