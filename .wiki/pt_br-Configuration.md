# ⚙️ Arquitetura de configuração em dois níveis
...
## 📜 Arquivo padrão `config/agrarian-reform.json` (Schema v2)
...
## 🖥️ Integração opcional de GUI do cliente (ModMenu & YACL v3)
...
*See also: [[Regras de jogo (GameRules)|pt_br-GameRules]], [[Registro de plantas e culturas universais|pt_br-Plant-Registry-and-Crop-Types]], and [[Configuração de desenvolvimento e compilação|pt_br-Developer-Setup-and-Building]]*.
