# ⚖️ Полный справочник игровых правил GameRules
...
## 📊 Таблица статических правил GameRules
...
## 🌾 Динамические правила множителей для культур
...
## 🛠️ Примеры команд администрирования
...
*See also: [[Команды Brigadier и администрирование|ru_ru-Commands]], [[Двухуровневая конфигурация|ru_ru-Configuration]], and [[Реестр растений и универсальные культуры|ru_ru-Plant-Registry-and-Crop-Types]]*.
