# 👟 Устойчивость почвы и защита от вытаптывания
...
*See also: [[Игровые правила (GameRules)|ru_ru-GameRules]], [[Эстетика и звуковое окружение|ru_ru-Aesthetics-and-Ambient-Feedback]], and [[API и интеграция аддонов|ru_ru-API-and-Addon-Integration]]*.
