# 🌿 Registro de plantas y soporte universal de cultivos
...
## 🔍 Motor dinámico de descubrimiento y clasificación
...
## 📊 Índice de plantas soportadas y etapas de crecimiento
...
## 🌾 Resolución de jerarquía de multiplicadores
...
## 🏷️ Integración de tags de datapacks (`AgrarianTags`)
...
*See also: [[El Continuo (Crecimiento offline)|es_es-The-Continuum-Offline-Persistence]], [[Multiplicador global de crecimiento|es_es-Global-Growth-Multiplier]], and [[Configuración de dos niveles|es_es-Configuration]]*.
