...
## 🛠️ Предварительные требования среды
...
## 🏗️ Структура подпроектов для нескольких версий
...
## 🔒 Обязательный заголовок лицензии
...
*See also: [[Архитектура и миксины|ru_ru-Architecture-and-Mixins]] and [[Совместимость версий и жизненный цикл|ru_ru-Version-Compatibility]]*.
