...
*See also: [[Brigadier 命令与管理|zh_cn-Commands]], [[双层配置系统|zh_cn-Configuration]], and [[作物注册表与通用作物|zh_cn-Plant-Registry-and-Crop-Types]]*.
