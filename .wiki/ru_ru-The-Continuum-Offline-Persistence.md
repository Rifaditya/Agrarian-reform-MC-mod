# ⏳ Континуум: Движок офлайн-роста растений
...
## 📊 Инфоблок технических характеристик
...
## 📐 Математические формулы догоняющего роста
...
## 💾 Сохранение чанков и нулевая запись на диск
...
*See also: [[Производительность и ограничение очереди|ru_ru-Performance-and-Queue-Throttling]], [[Реестр растений и универсальные культуры|ru_ru-Plant-Registry-and-Crop-Types]], and [[Архитектура и миксины|ru_ru-Architecture-and-Mixins]]*.
