...
## 📜 Default `config/agrarian-reform.json` (Schema v2)
...
*See also: [[GameRules|GameRules]], [[Plant Registry & Universal Crops|Plant-Registry-and-Crop-Types]], and [[Developer Setup & Building|Developer-Setup-and-Building]]*.
