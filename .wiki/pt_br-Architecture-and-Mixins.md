# 🏗️ Arquitetura e referência de injeções Mixin
...
## 📦 Hierarquia de pacotes do código
...
## 🎯 Tabela completa de injeções Mixin
...
## 💾 Armazenamento do mundo vs NBT dos chunks
...
*See also: [[O Continuum (Crescimento offline)|pt_br-The-Continuum-Offline-Persistence]], [[Desempenho e controle de filas|pt_br-Performance-and-Queue-Throttling]], and [[Configuração de desenvolvimento e compilação|pt_br-Developer-Setup-and-Building]]*.
