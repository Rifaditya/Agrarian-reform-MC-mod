...
## 🌊 Concentric Chebyshev Hydration Rings

In vanilla Minecraft, all water hydrates farmland within a static $9 \times 9$ box. Agrarian Reform implements a high-performance **Concentric Chebyshev Expanding Ring Sweep** ($r = 1 \to \text{maxRange}$ with $y \in [-1, 1]$ 3D elevation support):
...
Server admins can customize irrigation distance, toggle pure water filtering, or force farmland moisture:
