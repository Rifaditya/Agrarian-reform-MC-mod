# 🏗️ Архитектура и справочник точек внедрения Mixin
...
## 🎯 Полная таблица точек внедрения Mixin
...
## 💾 Хранилище мира против NBT чанков
...
*See also: [[Континуум (Офлайн-рост)|ru_ru-The-Continuum-Offline-Persistence]], [[Производительность и ограничение очереди|ru_ru-Performance-and-Queue-Throttling]], and [[Настройка среды разработки и сборка|ru_ru-Developer-Setup-and-Building]]*.
