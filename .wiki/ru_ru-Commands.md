# 💻 Команды Brigadier и администрирование
...
## 🛠️ Примеры использования и администрирования
...
*See also: [[Игровые правила (GameRules)|ru_ru-GameRules]] and [[Двухуровневая конфигурация|ru_ru-Configuration]]*.
