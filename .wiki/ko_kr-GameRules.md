# ⚖️ 네임스페이스 GameRules 게임 규칙 완전 레퍼런스
...
*See also: [[Brigadier 명령어 및 서버 관리|ko_kr-Commands]], [[2계층 설정 시스템|ko_kr-Configuration]], and [[작물 레지스트리 및 범용 작물|ko_kr-Plant-Registry-and-Crop-Types]]*.
