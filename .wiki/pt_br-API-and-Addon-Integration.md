# 🔌 Guia de integração de API e addons
...
## 📚 Dependências da API DasikLibrary
...
## 🏷️ Integrações de tags de datapacks personalizadas
...
*See also: [[Registro de plantas e culturas universais|pt_br-Plant-Registry-and-Crop-Types]] and [[Arquitetura e mixins|pt_br-Architecture-and-Mixins]]*.
