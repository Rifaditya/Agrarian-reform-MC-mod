# ⚙️ Architecture de configuration à deux niveaux
...
## 📜 Fichier par défaut `config/agrarian-reform.json` (Schema v2)
...
## 🖥️ Intégration GUI client optionnelle (ModMenu & YACL v3)
...
*See also: [[Règles de jeu (GameRules)|fr_fr-GameRules]], [[Registre des plantes et cultures universelles|fr_fr-Plant-Registry-and-Crop-Types]], and [[Environnement de développement et compilation|fr_fr-Developer-Setup-and-Building]]*.
