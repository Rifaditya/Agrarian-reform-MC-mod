...
## 📜 기본 `config/agrarian-reform.json` (Schema v2)
...
## 🖥️ 선택적 클라이언트 GUI 연동 (ModMenu & YACL v3)
...
*See also: [[게임 규칙 (GameRules) 레퍼런스|ko_kr-GameRules]], [[작물 레지스트리 및 범용 작물|ko_kr-Plant-Registry-and-Crop-Types]], and [[개발 환경 설정 및 빌드|ko_kr-Developer-Setup-and-Building]]*.
