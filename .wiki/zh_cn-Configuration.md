...
## 📜 默认 `config/agrarian-reform.json` (Schema v2)
...
## 🖥️ 可选客户端 GUI 集成 (ModMenu & YACL v3)
...
*See also: [[游戏规则 (GameRules) 参考|zh_cn-GameRules]], [[作物注册表与通用作物|zh_cn-Plant-Registry-and-Crop-Types]], and [[开发者环境与编译指南|zh_cn-Developer-Setup-and-Building]]*.
