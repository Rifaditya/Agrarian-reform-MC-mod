# 👟 Résilience des terres et protection du piétinement
...
*See also: [[Règles de jeu (GameRules)|fr_fr-GameRules]], [[Esthétique et retours d'ambiance|fr_fr-Aesthetics-and-Ambient-Feedback]], and [[API et intégration d'addons|fr_fr-API-and-Addon-Integration]]*.
