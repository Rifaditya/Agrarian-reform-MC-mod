...
*See also: [[性能优化与队列节流|zh_cn-Performance-and-Queue-Throttling]], [[作物注册表与通用作物|zh_cn-Plant-Registry-and-Crop-Types]], and [[时空连续体 (离线生长模拟)|zh_cn-The-Continuum-Offline-Persistence]]*.
