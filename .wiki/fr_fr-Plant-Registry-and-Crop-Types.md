# 🌿 Registre des plantes et cultures universelles
...
## 🔍 Moteur de détection dynamique et classification
...
## 📊 Index des plantes prises en charge et stades de croissance
...
## 🌾 Résolution de la hiérarchie des multiplicateurs
...
## 🏷️ Intégration des tags de datapacks (`AgrarianTags`)
...
*See also: [[Le Continuum (Croissance hors-ligne)|fr_fr-The-Continuum-Offline-Persistence]], [[Multiplicateur global de croissance|fr_fr-Global-Growth-Multiplier]], and [[Configuration à deux niveaux|fr_fr-Configuration]]*.
