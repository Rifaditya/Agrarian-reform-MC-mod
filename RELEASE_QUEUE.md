...
- [ ] **`2.2.4+26.3`** (2026-08-24) - - **Platform Expansion**: Scaffolded dedicated subproject for **Minecraft 26.3** targeting open-ended bounds (`>=26.3-`) and snapshot dependencies.
- [ ] **`2.2.5+26.3`** (2026-08-24) - - **Configuration Schema V2**: Upgraded AgrarianConfig with dynamic crop tracking schema (`forcedCrops`, `forcedGrowthMultipliers`), auto-population helpers, and thread-safe dirty state management (`saveIfDirty`).
