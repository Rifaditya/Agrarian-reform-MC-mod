...
*See also: [[게임 규칙 (GameRules) 레퍼런스|ko_kr-GameRules]], [[심미적 피드백 및 환경 음향|ko_kr-Aesthetics-and-Ambient-Feedback]], and [[API 및 애드온 통합|ko_kr-API-and-Addon-Integration]]*.
