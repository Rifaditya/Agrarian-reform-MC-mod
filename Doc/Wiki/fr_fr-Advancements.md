# 🏆 Progrès et progression du joueur
...
## 🌾 Interaction avec les progrès agricoles vanilla
...
## ⚙️ Vérification technique dans le code source
...
*See also: [[Règles de jeu (GameRules)|fr_fr-GameRules]] and [[Polyculture et biodiversité|fr_fr-Polyculture-and-Biodiversity]]*.
