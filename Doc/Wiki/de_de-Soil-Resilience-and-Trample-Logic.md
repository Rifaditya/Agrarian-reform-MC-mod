# 👟 Bodenresilienz und Trampelschutz
...
*See also: [[Spielregeln (GameRules)|de_de-GameRules]], [[Ästhetik und Umgebungsfeedback|de_de-Aesthetics-and-Ambient-Feedback]], and [[API und Addon-Integration|de_de-API-and-Addon-Integration]]*.
