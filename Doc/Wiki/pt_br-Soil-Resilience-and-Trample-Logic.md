# 👟 Resiliência do solo e proteção contra pisoteio
...
*See also: [[Regras de jogo (GameRules)|pt_br-GameRules]], [[Estética e ambientação sonora|pt_br-Aesthetics-and-Ambient-Feedback]], and [[API e integração de addons|pt_br-API-and-Addon-Integration]]*.
