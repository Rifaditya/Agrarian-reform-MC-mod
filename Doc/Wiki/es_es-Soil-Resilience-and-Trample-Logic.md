# 👟 Resistencia del suelo y protección contra pisoteo
...
## 👟 Reglas de protección de paso suave
...
*See also: [[Reglas de juego (GameRules)|es_es-GameRules]], [[Estética y respuesta ambiental|es_es-Aesthetics-and-Ambient-Feedback]], and [[API e integración de addons|es_es-API-and-Addon-Integration]]*.
