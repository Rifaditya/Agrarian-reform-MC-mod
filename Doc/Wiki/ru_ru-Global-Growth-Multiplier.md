# ⚡ Глобальный множитель роста и настройка культур
...
*See also: [[Производительность и ограничение очереди|ru_ru-Performance-and-Queue-Throttling]], [[Реестр растений и универсальные культуры|ru_ru-Plant-Registry-and-Crop-Types]], and [[Континуум (Офлайн-рост)|ru_ru-The-Continuum-Offline-Persistence]]*.
