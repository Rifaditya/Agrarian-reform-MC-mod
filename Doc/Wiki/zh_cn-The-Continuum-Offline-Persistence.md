...
*See also: [[性能优化与队列节流|zh_cn-Performance-and-Queue-Throttling]], [[作物注册表与通用作物|zh_cn-Plant-Registry-and-Crop-Types]], and [[架构设计与 Mixin 注入参考|zh_cn-Architecture-and-Mixins]]*.
