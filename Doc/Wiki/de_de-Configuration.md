# ⚙️ Zwei-Ebenen-Konfigurationsarchitektur
...
## 📜 Standarddatei `config/agrarian-reform.json` (Schema v2)
...
## 🖥️ Optionale Client-GUI-Integration (ModMenu & YACL v3)
...
*See also: [[Spielregeln (GameRules)|de_de-GameRules]], [[Pflanzenregister und universelle Feldfrüchte|de_de-Plant-Registry-and-Crop-Types]], and [[Entwickler-Setup und Kompilierung|de_de-Developer-Setup-and-Building]]*.
