...
## 🌾 Взаимодействие с ванильными достижениями
...
## ⚙️ Техническая верификация исходного кода
...
*See also: [[Игровые правила (GameRules)|ru_ru-GameRules]] and [[Поликультура и биоразнообразие|ru_ru-Polyculture-and-Biodiversity]]*.
