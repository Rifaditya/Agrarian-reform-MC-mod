# 💻 Configuração de desenvolvimento e compilação
...
## 🏗️ Estrutura de subprojetos multi-versão
...
## 🧪 Testes unitários headless automatizados
...
## 🔒 Cabeçalho de licença obrigatório
...
*See also: [[Arquitetura e mixins|pt_br-Architecture-and-Mixins]] and [[Compatibilidade de versões e ciclo de vida|pt_br-Version-Compatibility]]*.
