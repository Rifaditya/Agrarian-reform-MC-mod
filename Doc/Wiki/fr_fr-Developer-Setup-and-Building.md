...
## 🛠️ Prérequis de l'environnement
...
## 🏗️ Structure des sous-projets multi-versions
...
## 🧪 Tests unitaires headless automatisés
...
## 🔒 En-tête de licence obligatoire
...
*See also: [[Architecture et cibles Mixin|fr_fr-Architecture-and-Mixins]] and [[Compatibilité des versions et cycle de vie|fr_fr-Version-Compatibility]]*.
