# ⚙️ Arquitectura de configuración de dos niveles
...
## 📜 Archivo predeterminado `config/agrarian-reform.json` (Schema v2)
...
## 🖥️ Integración opcional de GUI en cliente (ModMenu y YACL v3)
...
*See also: [[Reglas de juego (GameRules)|es_es-GameRules]], [[Registro de cultivos y soporte universal|es_es-Plant-Registry-and-Crop-Types]], and [[Configuración de desarrollo y compilación|es_es-Developer-Setup-and-Building]]*.
