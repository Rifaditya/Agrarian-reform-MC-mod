# 🌿 Реестр растений и универсальное автообнаружение культур
...
## 🔍 Движок динамического обнаружения и классификации
...
## 📊 Индекс поддерживаемых растений и стадии роста
...
## 🌾 Иерархия множителей и состояние заморозки
...
## 🏷️ Интеграция тегов датапаков (`AgrarianTags`)
...
*See also: [[Континуум (Офлайн-рост)|ru_ru-The-Continuum-Offline-Persistence]], [[Глобальный множитель роста|ru_ru-Global-Growth-Multiplier]], and [[Двухуровневая конфигурация|ru_ru-Configuration]]*.
