# ⚖️ Référence complète des règles de jeu GameRules
...
## 📊 Tableau de référence des GameRules statiques
...
## 🌾 GameRules dynamiques de multiplicateur par culture
...
## 🛠️ Exemples de commandes d'administration
...
*See also: [[Commandes Brigadier et administration|fr_fr-Commands]], [[Configuration à deux niveaux|fr_fr-Configuration]], and [[Registre des plantes et cultures universelles|fr_fr-Plant-Registry-and-Crop-Types]]*.
