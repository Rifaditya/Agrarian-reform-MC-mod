# ⚙️ Arsitektur Konfigurasi Dua Tingkat
...
## 📜 Bawaan `config/agrarian-reform.json` (Schema v2)
...
## 🖥️ Integrasi GUI Klien Opsional (ModMenu & YACL v3)
...
*See also: [[Aturan Permainan (GameRules)|id_id-GameRules]], [[Registri Tanaman & Tanaman Universal|id_id-Plant-Registry-and-Crop-Types]], and [[Pengaturan Pengembang & Kompilasi|id_id-Developer-Setup-and-Building]]*.
