# 🏆 Progressos e evolução do jogador
...
## 🌾 Interação com progressos padrão de agricultura
...
## ⚙️ Verificação técnica com o código-fonte
...
*See also: [[Regras de jogo (GameRules)|pt_br-GameRules]] and [[Policultivo e biodiversidade|pt_br-Polyculture-and-Biodiversity]]*.
