...
## 🧪 How Polyculture Bonuses Work

When a crop receives a growth tick or catch-up calculation, the engine inspects its cardinal neighbors:
...
## ⚙️ Disabling Biodiversity Bonus

If admins prefer traditional monoculture mechanics, disable the bonus via GameRules:
...
*See also: [[The Continuum (Offline Growth)|The-Continuum-Offline-Persistence]] and [[Plant Registry & Crop Types|Plant-Registry-and-Crop-Types]]*.
