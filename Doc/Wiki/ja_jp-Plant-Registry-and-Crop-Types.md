...
*See also: [[コンティニュアム (オフライン成長持続)|ja_jp-The-Continuum-Offline-Persistence]], [[グローバル成長倍率と個別調整|ja_jp-Global-Growth-Multiplier]], and [[2層設定システム|ja_jp-Configuration]]*.
