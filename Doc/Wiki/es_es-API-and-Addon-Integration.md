# 🔌 API e integración para desarrolladores y addons
...
## 📚 Dependencias de la API de DasikLibrary
...
## 🌾 Fachada pública AgrarianCropRules
...
## 🏷️ Integraciones de tags de datapack personalizados
...
*See also: [[Registro de cultivos y soporte universal|es_es-Plant-Registry-and-Crop-Types]] and [[Arquitectura y mixins|es_es-Architecture-and-Mixins]]*.
