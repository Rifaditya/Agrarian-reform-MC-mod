# ⚙️ Двухуровневая архитектура конфигурации
...
## 📜 Файл по умолчанию `config/agrarian-reform.json` (Schema v2)
...
## 🖥️ Опциональный клиентский GUI (ModMenu и YACL v3)
...
*See also: [[Игровые правила (GameRules)|ru_ru-GameRules]], [[Реестр растений и универсальные культуры|ru_ru-Plant-Registry-and-Crop-Types]], and [[Настройка среды разработки и сборка|ru_ru-Developer-Setup-and-Building]]*.
