...
*See also: [[Устойчивость почвы и защита от вытаптывания|ru_ru-Soil-Resilience-and-Trample-Logic]] and [[Игровые правила (GameRules)|ru_ru-GameRules]]*.
