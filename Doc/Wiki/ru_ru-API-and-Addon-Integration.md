# 🔌 API и интеграция сторонних аддонов
...
## 🌾 Публичный фасад AgrarianCropRules
...
*See also: [[Реестр растений и универсальные культуры|ru_ru-Plant-Registry-and-Crop-Types]] and [[Архитектура и миксины|ru_ru-Architecture-and-Mixins]]*.
