...
## 📜 デフォルト `config/agrarian-reform.json` (Schema v2)
...
## 🖥️ 任意のクライアント GUI 統合 (ModMenu & YACL v3)
...
*See also: [[ゲームルール (GameRules) リファレンス|ja_jp-GameRules]], [[作物レジストリと汎用作物|ja_jp-Plant-Registry-and-Crop-Types]], and [[開発環境の構築とビルド|ja_jp-Developer-Setup-and-Building]]*.
