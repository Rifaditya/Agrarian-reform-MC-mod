...
*See also: [[パフォーマンスとキュー調整|ja_jp-Performance-and-Queue-Throttling]], [[作物レジストリと汎用作物|ja_jp-Plant-Registry-and-Crop-Types]], and [[アーキテクチャと Mixin ターゲット|ja_jp-Architecture-and-Mixins]]*.
